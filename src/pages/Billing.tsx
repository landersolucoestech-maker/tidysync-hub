...
export function Billing() {
  ...
  const getQBStatusIcon = (qbStatus: string) => {
    switch (qbStatus) {
            ...
            <CardContent>
              <div className="flex items-center gap-4 mb-6">
                <div className="relative flex-1">
                  ...
                  <Input
                    placeholder={searchField === "all" ? "Search by invoice, customer or job ID..." : searchField === "invoice" ? "Search by invoice ID..." : searchField === "customer" ? "Search by customer..." : "Search by job ID..."}
                    value={searchTerm}
